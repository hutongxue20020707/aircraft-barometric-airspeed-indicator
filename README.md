...
| 电路模块 | 方案选型 | 说明 |
|---|---|---|
| 传感器电路 | **BMP180 气压传感器**（压敏电阻式） | 对比压敏电阻与电容式两种方案，选择压敏电阻方案（成本低、电路结构简单）；通过 I²C 与单片机通信，采集气压信号 |
...
- **原理图设计**：使用**嘉立创 EDA** 绘制传感器电路、单片机最小系统、显示电路、电源电路四部分原理图
- **PCB 设计**：在原理图基础上完成**单层 PCB** 布局与走线设计
- **实物形态**：原理样机（面包板 + 模块化搭建），用于功能验证与调试测试
...
- 设计工作内容：方案对比与选型、**嘉立创 EDA 电路原理图与单层 PCB 设计**、程序编写、实物装配与调试测试。
- 仓库中的 PDF 文档已对个人学号信息做打码处理。
